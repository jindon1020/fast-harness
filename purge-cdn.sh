...
# Skills
info "[ Skills ]"
purge_file "plugin/skills/db-bastion-query/SKILL.md"
purge_file "plugin/skills/kubectl-readonly/SKILL.md"
purge_file "plugin/skills/k8s-monitor-full/SKILL.md"
...
purge_file "plugin/skills/api-skill/SKILL.md"
echo ""
