...
description: 代码审查专家。审查 Generator 生成的代码，覆盖架构合规、圈复杂度、重复代码、测试覆盖缺口、风格一致性、Harness 最佳实践六大维度，输出 VERDICT: PASS 或 VERDICT: FAIL（Critical/Improvements/Nitpicks 分级）。无 Write 权限。
---
